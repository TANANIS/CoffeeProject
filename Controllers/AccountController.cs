...
namespace Coffee.Controllers
{
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userId != null)
                {
                    ...
                    if (login != null)
                    {
                        ...
                        return RedirectToAction("Index", "Home"); //登入後預設為Account的Index畫面
                    }
                }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var products = await _context.Products.ToDictionaryAsync(p => p.ProductId, p => p.ProductName);


            var headerViewModels = orderHeaders.Select(async o => new headerViewModel
            {
                OrderId = o.OrderId,
                Id = o.Id,
                ...
                DetailViewModels = await _context.Orderdetails
                                       .Where(d => d.OrderId == o.OrderId)
                                       .Select(d => new DetailViewModel
                                       {
                                           ProductId = d.ProductId,
                                           ProductName = products.ContainsKey(d.ProductId) ? products[d.ProductId] : "找不到產品名稱",
                                           OrderId = d.OrderId,
